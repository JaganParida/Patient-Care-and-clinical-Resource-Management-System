<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  <%@ page isELIgnored="false" %>
          ...
          <ul class="navbar-nav mx-auto align-items-lg-center">
            ...
            <li class="nav-item px-2">
              <a class="nav-link fw-medium text-dark position-relative" href="#section-header">
                <i class="fa-solid fa-stethoscope me-1"></i> Services
              </a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link fw-medium text-dark position-relative" href="../doctor/index.jsp">
            ...
            <c:if test="${empty userObj}">
              ...
              <li class="nav-item dropdown px-2 position-relative">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 p-3"
                  ...
                  <li>
                    <a class="dropdown-item text-center text-primary fw-semibold" href="../role_selection.jsp">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 p-2"
                  ...
                  <li>
                    <a class="dropdown-item d-flex align-items-center text-dark p-2" href="medical_records.jsp">
                      <i class="fa-regular fa-file-medical me-2 fa-fw"></i> Medical Records
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item d-flex align-items-center text-dark p-2" href="prescriptions.jsp">
                      <i class="fa-regular fa-prescription me-2 fa-fw"></i> Prescriptions
                    </a>
                  </li>
                  <li>
                    <hr class="dropdown-divider my-2">
    ...
    <script>
      // Add smooth interactions - REMOVED HOVER FUNCTIONALITY
