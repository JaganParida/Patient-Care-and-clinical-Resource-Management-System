...
<head>
    <meta charset="UTF-8">
    <title>Admin Registration - Hospital Management System</title>
...
<body>
    ...
    <div class="signup-container">
        <div class="signup-header">
            <h1><i class="fas fa-user-shield me-2"></i>Admin Registration</h1>
            <p>Create your administrator account for hospital management system</p>
        </div>
        ...
        <div class="signup-card">
            <div class="form-section">
                ...
                <form action="admin_register" method="post" id="adminForm" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="employeeId" name="employeeId"
                                    placeholder="Enter your employee ID" required minlength="3" maxlength="20">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="department" name="department"
                                    placeholder="Enter your department" required minlength="2" maxlength="50">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="position" name="position"
                                    placeholder="Enter your position" required minlength="2" maxlength="50">
                    ...
                    <div class="form-group">
                        <label for="accessLevel" class="form-label">
                            <i class="fas fa-user-tag"></i>Access Level
                        </label>
                        <div class="input-group">
