...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Fixed: Icon color change on focus - using multiple approaches */
    ...
    <div class="signup-container">
        ...
        <div class="signup-card">
            <div class="form-section">
                ...
                <form action="<%=request.getContextPath()%>/register" method="post" id="patientForm" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" id="address" name="address" rows="3" 
                                      placeholder="Enter your complete address" required minlength="10" maxlength="200"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="emergencyContactName" name="emergencyContactName" 
                                       placeholder="Full name of emergency contact" required minlength="3" maxlength="50">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="tel" class="form-control" id="emergencyContactPhone" name="emergencyContactPhone" 
                                       placeholder="Phone number of emergency contact" required pattern="[0-9]{10}">
                        ...
                        <label for="allergies" class="form-label">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="allergies" name="allergies" 
                                       placeholder="List any known allergies (if any)" maxlength="100">
                                <i class="input-icon fas fa-allergies"></i>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" id="medicalHistory" name="medicalHistory" rows="3" 
                                      placeholder="Any relevant medical history, chronic conditions, or past surgeries" maxlength="500"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="insuranceProvider" name="insuranceProvider" 
                                       placeholder="Insurance company name" maxlength="50">
                                <i class="input-icon fas fa-building"></i>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="insurancePolicyNumber" class="form-label">
                                <i class="fas fa-id-card"></i>Policy Number
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="insurancePolicyNumber" name="insurancePolicyNumber" 
                                       placeholder="Insurance policy number" maxlength="20">
                ...
                <a href="user_Login.jsp" class="login-link">
